          ...
          >
            ...
            <div className="grid gap-2.5 border-t pt-3">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button type="button" size="sm" variant="outline" className="h-9 text-xs cursor-pointer" onClick={() => addServico(novoServico)}>
                ...
                <div className="border rounded-xl p-3 bg-muted/20 space-y-2 mt-1">
                  ...
                  <div className="grid gap-2">
                    {servicos.map((s, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-center justify-between gap-3 bg-card p-2 rounded-lg border text-xs">
            ...
            <DialogFooter className="pt-2 border-t">
              <Button type="button" variant="ghost" className="cursor-pointer" onClick={() => setOpen(false)}>Cancelar</Button>
